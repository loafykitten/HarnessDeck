...
import type { Greeting, HarnessId, HarnessMeta, News, ProjectInfo, SessionInfo, Updates, Usage } from "../types/api";
import { petOrDefault, type PetId } from "../components/pets/pets";
